...
images:[]
    ...
    methods:{
      ...
      AddFleet:function(){
          this.$http.post('http://localhost:3000/addFleet',{"title":this.name,"type":this.type, "design":this.design, "class":this.class, "built":this.built, "tonnage":this.tonnage, "draft":this.draft, "deckSpace":this.deckSpace, "deckSpace":this.deckSpace, "deckStrength":this.deckStrength, "deckDimensions":this.deckDimensions, "crane":this.crane, "accomadation":this.accomadation, "flag":this.flag, "bollardPull":this.bollardPull, "fireFighting":this.fireFighting, "helideck":this.helideck},{headers : {'jwt-token' : localStorage.getItem('id_token')}}).then(data => {
