! function(e) {
  e.fn.disableSelection_dropotron = function() {
    ...
    n.on("doCollapseAll", function() {
      ...
      var t = e(this),
        n = t.parent();
      0 < o.hideDelay && t.add(n).on("mouseleave", function() {
        window.clearTimeout(c), c = window.setTimeout(function() {
          t.trigger("doCollapse")
        }, o.hideDelay)
      }), t.disableSelection_dropotron().hide().addClass(o.menuClass).css("position", "absolute").on("mouseenter", function() {
        ...
        navigator.userAgent.match(/MSIE ([0-9]+)\./) && 8 > RegExp.$1 && (d += o.IEOffsetX, f += o.IEOffsetY), t.css("left", d + "px").css("top", f + "px").css("opacity", "0.01").show();
        var C = !1;
        switch (d = "relative" == n.css("position") || "absolute" == n.css("position") ? -1 * p.left : 0, 0 > t.offset().left ? (d += n.parent().outerWidth() - o.offsetX, C = !0) : t.offset().left + g > l.width() && (d += -1 * n.parent().outerWidth() - o.offsetX, C = !0), C && t.css("left", d + "px"), t.hide().css("opacity", "1"), o.mode) {
          case "zoom":
        ...
        return !!t.is(":visible") && (t.hide(), n.removeClass(o.openerActiveClass), t.find("." + o.openerActiveClass).removeClass(o.openerActiveClass), t.find("ul").hide(), !1)
      ...
      }), "hover" == o.expandMode && n.hover(function() {
      ...
      r || 1 > e(this).attr("href").length && t.preventDefault()
      ...
      }), 0 < o.length && 0 == s.length && t.on("click touchend", function(e) {
      ...
      if (0 < s.length) {
        ...
        for (var a = o.baseZIndex, l = 1, r = s; 0 < r.length; l++) r.css("z-index", a++), o.submenuClassPrefix && r.addClass(o.submenuClassPrefix + (a - 1 - o.baseZIndex)), r = r.find("> li > ul")
      }
